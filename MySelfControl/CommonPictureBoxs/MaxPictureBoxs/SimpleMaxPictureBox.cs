...
{
    public partial class SimpleMaxPictureBox : UserControl
    {
        private static Image closeBlackImage = StaticImageLoad.LoadImage(@"\Resources\Img_32\max_black_32.png");
        private static Image closeRedImage = StaticImageLoad.LoadImage(@"\Resources\Img_32\max_red_32.png");

        public SimpleMaxPictureBox()
        {
            InitializeComponent();
        }
