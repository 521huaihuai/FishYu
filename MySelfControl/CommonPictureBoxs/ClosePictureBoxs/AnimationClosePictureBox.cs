...
{
    public partial class AnimationClosePictureBox : UserControl, IAnimation
    {
        private int index = 0;
        private Point moveInPoint;
        private Point picPoint;
        private Brush backBrush = null;
        private static bool IsDesignMode = DesignModeUtil.Instance.IsDesignMode;
        ...
        private static Image closeWhiteImage = StaticImageLoad.LoadImage(@"\Resources\Img_32\close_white.png");
