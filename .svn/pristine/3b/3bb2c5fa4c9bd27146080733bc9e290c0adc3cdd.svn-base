...
namespace FishyuSelfControl.CommonPictureBoxs.MaxPictureBoxs
{
    public partial class AnimationMaxPictureBox : UserControl, IAnimation
    {
        private int index = 0;
        ...
        private static Image maxBlackImage = StaticImageLoad.LoadImage(@"\Resources\Img_32\max_black_32.png");
        private static Image maxRedImage = StaticImageLoad.LoadImage(@"\Resources\Img_32\max_red_32.png");
        private static Image maxWhiteImage = StaticImageLoad.LoadImage(@"\Resources\Img_32\max_white_32.png");
        ...
        private void AnimationClosePictureBox_Load(object sender, EventArgs e)
        {
            ...
            pictureBox1.BackgroundImage = maxBlackImage;
        ...
        private void pictureBox1_MouseEnter_1(object sender, EventArgs e)
        {
            ...
            switch (MyDisplayStyle)
            {
                case DisplayStyle.Default:
                    pictureBox1.BackgroundImage = maxRedImage;
                    break;
                case DisplayStyle.Black2RedBackground:
                    pictureBox1.BackgroundImage = maxWhiteImage;
                    break;
                default:
                    pictureBox1.BackgroundImage = maxRedImage;
                    break;
